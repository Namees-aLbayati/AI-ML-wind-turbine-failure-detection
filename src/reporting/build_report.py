...
h1 {{font-size:2.65rem;line-height:1.12;margin:0 0 10px;color:white;max-width:760px}} h2 {{margin-top:48px;border-bottom:3px solid var(--teal);padding-bottom:8px;color:var(--navy)}} h3 {{margin-top:30px;color:var(--blue)}} h4 {{color:var(--blue);margin-bottom:5px}}
