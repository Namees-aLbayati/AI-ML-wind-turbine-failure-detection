...
The same updated notebook is published through `index.html` and `docs/index.html` for GitHub Pages.
...
the revised notebook. The GitHub Pages site displays the updated full notebook. The separate archived-style
executive report still describes the earlier PR-AUC/F2 workflow above. Neither workflow is fresh external validation.
